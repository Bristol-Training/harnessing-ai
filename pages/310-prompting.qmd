...
Independently of the prompting framework that you are using, take extra care when using AI tools with:

⚠️ **Personal data** — student, staff or health information

⚠️ **Confidential research** — unpublished findings or applications

⚠️ **Commercially sensitive information** — agreements or financial information

⚠️ **Legally privileged information** — legal advice or disciplinary matters

⚠️ **Security-sensitive information** — system configurations or access information

Before using sensitive information, **check University policies and guidance and make sure the AI tool is approved and appropriate for that data**.

Also understand **what files or connected services the AI tool can access**. AI tools may be able to retrieve information beyond what you explicitly upload, creating a risk of unintended disclosure.

**Never share passwords or access credentials with AI tools**.
